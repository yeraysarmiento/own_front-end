...
describe("Given an OwnMenu component", () => {
    describe("When it is rendered", () => {
        ...
        test("Then it should render 2 li elements with 'Login' & 'Register", () => {
            const registerText = '<li class="nav__element nav__element--register">Register</li>';
            // const loginText =
            //   '<li class="nav__element nav__element--login">Login</li>';
            const logoutText = '<li class="nav__element nav__element--logout"> Logout </li>';
            const wrapper = mount(OwnHeader, {
                global: {
                    plugins: [router],
                    mocks: {
...
//# sourceMappingURL=OwnHeader.spec.js.map